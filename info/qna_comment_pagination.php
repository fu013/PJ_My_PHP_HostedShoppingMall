<?php
   ...
   $con = mysqli_connect("localhost","seungchanshop","tmdcks2416!","seungchanshop");
    $product_miyaong = "select * from seungchanshop.qna_comment where qna_no = $post_no";
    ...
    $product_select = 'select * from seungchanshop.qna_comment'.' '.$sqlLimit; // 프로덕트에 대한정보 + 해당 프로덕트넘버와 같은 프로덕트넘버를 가진 메인이미지네임을 가져옴.
