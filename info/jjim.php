<?php
    ...
    if(isset($_SESSION["login_user_id"])) { 
        ...
        $jjim_select = "select count(*) count from seungchanshop.user_jjim where product_autoNum = $post_no and user_id = '$user_id'";
        ...
        if ($jjim_count_row) {
            ...
            $insert_jjim = "insert into seungchanshop.user_jjim(product_autoNum, user_id, main_img_dir_name, product_category, product_name, product_size, product_color, product_price)";
